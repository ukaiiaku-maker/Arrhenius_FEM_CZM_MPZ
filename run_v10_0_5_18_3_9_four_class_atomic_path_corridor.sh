...
TMP=$(mktemp "${TMPDIR:-/tmp}/v10051839_atomic_corridor_runner.XXXXXX")
trap 'rm -f "$TMP"' EXIT

sed \
  -e 's/mode_i_first_passage_v10_0_5_18_3_4_four_class_path_aware_growth_envelope/mode_i_first_passage_v10_0_5_18_3_9_atomic_path_corridor/g' \
  -e 's/persistent_site_production_manifest_v10_0_5_18_3_4.json/persistent_site_production_manifest_v10_0_5_18_3_9.json/g' \
  -e 's/release=10.0.5.18.3.4/release=10.0.5.18.3.9/g' \
  -e 's/Focused v10.0.5.18.3.4 path-envelope validation complete/Focused v10.0.5.18.3.9 atomic path-corridor validation complete/g' \
  "$BASE_RUNNER" > "$TMP"
