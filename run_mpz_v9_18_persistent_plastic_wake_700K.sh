...
OUTROOT=${OUTROOT:-runs/mpz_v9_18_persistent_plastic_wake_700K_v1}
AUDIT_OUT=${AUDIT_OUT:-runs/mpz_v9_18_matched_stress_audit_700K_v1}
SEEDS=${SEEDS:-"1"}
...
"$PYTHON_BIN" run_mpz_v9_18_persistent_plastic_wake.py \
  --parameter-root "$PARAMETER_ROOT" \
  --outroot "$OUTROOT" \
  --seeds "$SEEDS" \
  --classes "$CLASSES" \
