...
MANIFEST_ROOT="${MANIFEST_ROOT:-runs/mpz_v9_10_3_dbtt_targeted_global_search_v1}"
OUTROOT="${OUTROOT:-runs/mpz_v9_10_3_dbtt_spatial_screen_50um_v1}"
...
# The v9.10.3 change is objective-only.  Spatial physics remains the validated
# v9.10.2 independent-shape unified MPZ implementation.
