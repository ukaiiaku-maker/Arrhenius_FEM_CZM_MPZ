...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_18_weakT_ceramic_5T_100um_stochastic_emission_theta${THETA:-30}_v1}
...
release=10.0.5.18
entry=arrhenius_fracture.mode_i_first_passage_v10_0_5_18_four_class_stochastic_emission
...
run_case() {
  ...
  local MANIFEST="$OUT/persistent_site_production_manifest_v10_0_5_18.json"
  ...
  env \
    ...
    EMISSION_MAX_ACTION_SUBSTEP="$EMISSION_MAX_ACTION_SUBSTEP" \
    EMISSION_MAX_EVENTS_PER_HALF_STEP="$EMISSION_MAX_EVENTS_PER_HALF_STEP" \
    python -m arrhenius_fracture.mode_i_first_passage_v10_0_5_18_four_class_stochastic_emission \
...
echo "Focused v10.0.5.18 validation complete: $CAMPAIGN_ROOT"
