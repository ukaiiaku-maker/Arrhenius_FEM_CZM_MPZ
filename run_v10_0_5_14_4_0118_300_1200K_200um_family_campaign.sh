...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_14_4_0118_300_1200K_200um_family_v1}
...
run_case() {
  ...
  local MANIFEST="$OUT/persistent_site_production_manifest_v10_0_5_14_4.json"
  ...
  python -m \
    arrhenius_fracture.mode_i_first_passage_v10_0_5_14_4_persistent_site_family \
