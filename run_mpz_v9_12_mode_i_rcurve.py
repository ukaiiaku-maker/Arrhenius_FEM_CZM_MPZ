#!/usr/bin/env python3
"""Compatibility wrapper selecting the v9.12 Mode-I full-field entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v912
    try:
        return _base.main()
    finally:
