...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_18_3_1_weakT_ceramic_5T_100um_single_layer_theta${THETA:-30}_v1}
...
EMISSION_INNER_MAX_LOG_HAZARD_CHANGE=${EMISSION_INNER_MAX_LOG_HAZARD_CHANGE:-0.5}
...
release=10.0.5.18.3.1
entry=arrhenius_fracture.mode_i_first_passage_v10_0_5_18_3_1_four_class_single_layer_load_ramp_stochastic_emission
...
run_case() {
  ...
  local MANIFEST="$OUT/persistent_site_production_manifest_v10_0_5_18_3_1.json"
  ...
  env \
    ...
    python -u -m arrhenius_fracture.mode_i_first_passage_v10_0_5_18_3_1_four_class_single_layer_load_ramp_stochastic_emission \
...
echo "Focused v10.0.5.18.3.1 validation complete: $CAMPAIGN_ROOT"
