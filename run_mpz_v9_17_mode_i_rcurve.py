#!/usr/bin/env python3
"""Select the v9.17 absolute-hazard trial-opening Mode-I entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v917
    try:
        return _base.main()
    finally:
