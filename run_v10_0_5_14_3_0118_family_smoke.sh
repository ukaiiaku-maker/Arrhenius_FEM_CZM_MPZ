...
OUTROOT=${OUTROOT:-$ROOT/runs/v10_0_5_14_3_0118_700K_20um_family_smoke_v1}
...
cat <<EOF
v10.0.5.14.3 candidate-0118 kernel-family smoke
  root:        $ROOT
  family:      $FAMILY_JSON
  output:      $OUTROOT
  temperature: ${T_K} K
  ...
  dU / dt:     $DU / $DT s
  transport:   adaptive exact frozen-generator exponential upwind
EOF

set -o pipefail
python -m arrhenius_fracture.mode_i_first_passage_v10_0_5_14_3_persistent_site_family \
