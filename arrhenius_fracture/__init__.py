...
# Install the v9.10.4.3 count-aware numerical timestep guard after the earlier
# guard.  It changes only timestep selection and retains the exact constitutive
# updates.
from . import reduced_campaign_front_v91043_timestep_guard as _v91043_timestep_guard

__version__ = '0.9.10.4.3'
