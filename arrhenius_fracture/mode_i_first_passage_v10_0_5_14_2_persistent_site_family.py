"""v10.0.5.14.2: kernel-family parity with stiff implicit MPZ transport."""
...
POINT_RELEASE = "10.0.5.14.2"
MODEL_ID = (
    "FEM_CZM_full_2D_PF_v10_2_22_persistent_site_kernel_family_"
    "implicit_transport_v10_0_5_14_2"
)
PRODUCTION_MANIFEST = "persistent_site_production_manifest_v10_0_5_14_2.json"
SELECTION_MANIFEST = "persistent_site_parameter_selection_v10_0_5_14_2.json"
...
def _rewrite_release_metadata(out: Path | None) -> None:
    ...
    if manifest.is_file():
        ...
        payload["schema"] = "persistent_site_production_manifest_v10_0_5_14_2"
...
def main(argv: list[str] | None = None):
    ...
    _engine.MODEL_ID = "FEM_CZM_persistent_site_front_engine_v10_0_5_14_2"
    try:
