#!/usr/bin/env python3
"""Compatibility wrapper selecting the v9.12.1 Mode-I full-field entry."""
...
def main():
    ...
    _base.build_command = _build_command_v9121
    try:
        return _base.main()
    finally:
