#!/usr/bin/env python3
"""v9.18.4 campaign: committed completion plus mechanically valid front regularization."""
...
def _build_command_v9184(args, class_name, run_root, force_rerun):
    cmd = _v9181._original_build(args, class_name, run_root, force_rerun)
    old = "run_mpz_v9_18_mode_i_rcurve.py"
    new = "run_mpz_v9_18_4_mode_i_rcurve.py"
    try:
...
def main():
    ...
    _v9181._build_command_v9181 = _build_command_v9184
    try:
        return _v9182.main()
    finally:
