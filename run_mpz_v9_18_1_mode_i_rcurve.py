#!/usr/bin/env python3
"""Select the v9.18.1 active-event renewal rollback entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v9181
    try:
        return _base.main()
    finally:
