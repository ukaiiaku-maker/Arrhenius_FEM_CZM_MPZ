#!/usr/bin/env python3
"""Select the v9.17.1 one-fire routing-fixed Mode-I entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v9171
    try:
        return _base.main()
    finally:
