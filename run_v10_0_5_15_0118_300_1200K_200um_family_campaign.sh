...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_15_0118_300_1200K_200um_pf_parity_v1}
...
release=10.0.5.15
entry=arrhenius_fracture.mode_i_first_passage_v10_0_5_15_pf_parity
candidate=v912_peak_0118_persistent_sites
PF_reference_commit=198ece3aeb1d193a8c1c4857676fba720c088d27
PF_update_map=emit_exchange_zero_recovery_population_weighted_scalar_advection
moving_tip_coupling=Strang_half_plastic_fractional_advance_half_plastic
...
run_case() {
  ...
  local MANIFEST="$OUT/persistent_site_production_manifest_v10_0_5_15.json"
  ...
  echo "  PF map:      exact sequential signed-state update"
  echo "  tip motion:  continuous fractional MPZ translation"
  echo "============================================================"

  python -m arrhenius_fracture.mode_i_first_passage_v10_0_5_15_pf_parity \
