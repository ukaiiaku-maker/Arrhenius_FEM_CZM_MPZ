...
SETUP="$ROOT_DIR/setup_panels_CD_local_env_v2.sh"
DRIVER="$ROOT_DIR/build_panels_CD_entropy_family_v2.py"
SHARED="$ROOT_DIR/shared_entropy_family_v2.py"
...
"$PY" "$DRIVER" \
  --out "${OUT:-runs/panels_CD_entropy_family_v2}" \
  --A-T-kB "${A_T_KB:-0 4 8 12 16}" \
