...
OUTROOT=${OUTROOT:-runs/mpz_v9_17_1_hazard_clock_source_refresh_700K_v1}
AUDIT_OUT=${AUDIT_OUT:-runs/mpz_v9_17_1_matched_stress_audit_700K_v1}
SEEDS=${SEEDS:-"1"}
...
"$PYTHON_BIN" run_mpz_v9_17_1_hazard_clock_source_refresh.py \
  --parameter-root "$PARAMETER_ROOT" \
  --outroot "$OUTROOT" \
  --seeds "$SEEDS" \
  --classes "$CLASSES" \
