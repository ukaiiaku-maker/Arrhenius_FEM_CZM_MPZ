#!/usr/bin/env python3
"""Select the v9.18.3 edge-aware geometry-recovery Mode-I entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v9183
    try:
        return _base.main()
    finally:
