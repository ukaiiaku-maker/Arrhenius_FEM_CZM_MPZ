...
MANIFEST_ROOT="${MANIFEST_ROOT:-runs/mpz_v9_10_2_independent_shape_global_search_v1}"
OUTROOT="${OUTROOT:-runs/mpz_v9_10_2_independent_shape_spatial_promotion_v1}"
CLASSES="${CLASSES:-ceramic weakT DBTT}"
TEMPERATURES="${TEMPERATURES:-300 700 900 1200}"
MAX_PER_CLASS="${MAX_PER_CLASS:-5}"
