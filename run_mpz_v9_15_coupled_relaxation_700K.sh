...
OUTROOT=${OUTROOT:-runs/mpz_v9_15_coupled_relaxation_700K_v1}
SEEDS=${SEEDS:-"1"}
...
EVENT_RELAXATION_SUBSTEPS=${EVENT_RELAXATION_SUBSTEPS:-12}
...
RNG_COUPLING=common \
"$PYTHON_BIN" run_mpz_v9_15_coupled_relaxation.py \
  --outroot "$OUTROOT" \
  --seeds "$SEEDS" \
  --classes "$CLASSES" \
  --T-K "$T_K" \
