...
def main() -> None:
    ...
    ap.add_argument("--crystal-theta-deg", type=float, default=0.0,
                    help="Crystal orientation angle [deg] forwarded to both the 2-D K-calibration run and the production 2-D fatigue run.")
    ...
    print(f"[v8 orientation audit] crystal_theta_deg={args.crystal_theta_deg:g}; "
          "crystal_aniso=ON; crystal_branch=ON")
