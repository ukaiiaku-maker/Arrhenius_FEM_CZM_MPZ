...
print("Panels C/D v3 numerical stack OK")
PY

conda list -p "$ENV_PREFIX" --explicit > "$ROOT_DIR/panels_CD_v3_local_environment_explicit.txt"
echo "Wrote exact environment export: $ROOT_DIR/panels_CD_v3_local_environment_explicit.txt"
