#!/usr/bin/env python3
"""Two-basis isotropic elastic calibration for mixed-mode FEM/CZM v3.2.

The authoritative amplitude in v3.2 comes from the domain J integral.  This
...
def main():
    ...
    p.add_argument('--out',default='runs/mixed_mode_fem_czm_v3_2_signed_basis_calibration')
    ...
    from arrhenius_fracture.mixed_mode_first_passage_v3_2 import (
    ...
    datasets=[('elastic_alpha_grid_v3_2.csv',grid),('mixed_mode_loading_calibration_v3_2.csv',mappings)]
    ...
    payload={'model':MODEL_ID,'settings':vars(a),'basis_matrix_raw':M_raw.tolist(),'basis_matrix':M.tolist(),'mode_signs':mode_signs.tolist(),
             ...
             'mapping':mappings}
    (out/'mixed_mode_loading_calibration_v3_2.json').write_text(json.dumps(payload,indent=2))
    ...
    print('wrote',out/'mixed_mode_loading_calibration_v3_2.csv')
