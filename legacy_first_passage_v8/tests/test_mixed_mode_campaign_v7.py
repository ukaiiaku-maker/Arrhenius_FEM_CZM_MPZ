...
class CampaignTests(unittest.TestCase):
    def test_calibration_invokes_exact_backend(self):
        s = Path("calibrate_mixed_mode_loading_v7.py").read_text()
    ...
    def test_phase_reliability_is_separate(self):
        s = Path("arrhenius_fracture/mixed_mode_first_passage_v7.py").read_text()
    ...
    def test_full_circle_coefficients_are_passed(self):
        s = Path("run_mixed_mode_fem_czm_v7_campaign.py").read_text()
    ...
    def test_event_controller_uses_empirical_alpha(self):
        ...
        self.assertIn("mixed_mode_control_history_v7.csv", s)
