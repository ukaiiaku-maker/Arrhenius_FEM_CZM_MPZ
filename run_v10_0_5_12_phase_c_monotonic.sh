...
case "$MODE" in
  smoke)
    DEFAULT_OUTROOT=runs/v10_0_5_12_3_phase_c_smoke_DBTT_700K_50um_v1
    ;;
  anchors)
    DEFAULT_OUTROOT=runs/v10_0_5_12_3_phase_c_500um_theta45_v1
    ;;
  full)
    DEFAULT_OUTROOT=runs/v10_0_5_12_3_phase_c_500um_theta45_v1
    ;;
...
args=(
  "$PYTHON_BIN" run_v10_0_5_12_3_phase_c_monotonic.py
  --mode "$MODE"
