...
def _build_command_v91855(py, args, class_name, manifest, T_K, case_dir):
    cmd = _original_build_command(py, args, class_name, manifest, T_K, case_dir)
    old = "arrhenius_fracture.mode_i_first_passage_v9_11"
    new = "arrhenius_fracture.mode_i_first_passage_v9_18_5_5"
    try:
...
def main():
    ...
    _base.build_command = _build_command_v91855
    try:
        return _base.main()
    finally:
