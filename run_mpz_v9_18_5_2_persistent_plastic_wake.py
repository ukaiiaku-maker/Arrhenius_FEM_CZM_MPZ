#!/usr/bin/env python3
"""v9.18.5.2 campaign: startup-safe target stop plus compact corridor mesh."""
...
def _build_command_v91852(args, class_name, run_root, force_rerun):
    cmd = _v9181._original_build(args, class_name, run_root, force_rerun)
    old = "run_mpz_v9_18_mode_i_rcurve.py"
    new = "run_mpz_v9_18_5_2_mode_i_rcurve.py"
    try:
...
def main():
    ...
    _v9181._build_command_v9181 = _build_command_v91852
    try:
        return _v9182.main()
    finally:
