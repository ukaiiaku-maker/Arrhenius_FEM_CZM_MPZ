...
SEED = 3100913530
LIMIT = int(os.environ.get("PEAK1000_DIAGNOSTIC_HAZARD_LIMIT", "3000"))
...
os.environ["EMISSION_INNER_MAX_ACTION_ERROR"] = os.environ.get(
    "EMISSION_INNER_MAX_ACTION_ERROR", "0.25"
)
os.environ["EMISSION_INNER_MAX_REFINEMENTS"] = os.environ.get(
    "EMISSION_INNER_MAX_REFINEMENTS", "64"
)
...
error = None
try:
    engine.predict_clock_increment_drives(16.5e6, 16.5e6, 1000.0, 840.0)
    completed = True
...
print("PEAK1000_ACTION_ERROR_TIMING " + json.dumps(payload, sort_keys=True), flush=True)
