...
OUT=${OUT:-runs/mpz_v9_10_4_4_current_dbtt_audit_v1}
...
echo "========================================================================"
echo "v9.10.4.4 DBTT historical-candidate audit"
...
PYTHONUNBUFFERED=1 python audit_mpz_v9_10_4_4_current_dbtt.py \
  --manifest "$MANIFEST" \
  --temperatures "$TEMPS" \
