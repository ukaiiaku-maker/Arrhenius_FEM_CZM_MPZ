...
case "$MODE" in
  smoke)
    DEFAULT_OUTROOT="$ROOT_DIR/runs/v10_0_5_13_2_barrier_only_DBTT_700K_20um_smoke_v1"
    ;;
  full)
    DEFAULT_OUTROOT="$ROOT_DIR/runs/v10_0_5_13_2_barrier_only_4class_300_1200K_100um_v1"
    ;;
  *)
...
args=(
  "$PYTHON_BIN" "$ROOT_DIR/run_v10_0_5_13_2_barrier_only_monotonic.py"
  --mode "$MODE"
...
printf 'Python: %s\n' "$PYTHON_BIN"
printf 'Output: %s\n' "$OUTROOT"
printf 'Point release: 10.0.5.13.2\n'
printf 'Launching:'
printf ' %q' "${args[@]}"
printf '\n'
