...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_18_2_weakT_ceramic_5T_100um_state_coupled_theta${THETA:-30}_v1}
...
EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE=${EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE:-0.25}
EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION=${EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION:-0.05}
EMISSION_ADAPT_MAX_GEOMETRY_FRACTION=${EMISSION_ADAPT_MAX_GEOMETRY_FRACTION:-0.05}
...
def seed_for(option: str, temperature: int) -> int:
    token = (
        f"v10.0.5.18.2|base={base}|option={option}|T={temperature}|"
...
release=10.0.5.18.2
entry=arrhenius_fracture.mode_i_first_passage_v10_0_5_18_2_four_class_state_coupled_stochastic_emission
...
emission_adapt_max_log_hazard_change=$EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE
emission_adapt_max_backstress_fraction=$EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION
emission_adapt_max_geometry_fraction=$EMISSION_ADAPT_MAX_GEOMETRY_FRACTION
...
run_case() {
  ...
  local MANIFEST="$OUT/persistent_site_production_manifest_v10_0_5_18_2.json"
  ...
  env \
    ...
    EMISSION_ADAPT_REFERENCE_TARGET="$ADAPTIVE_EVENT_TARGET" \
    EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE="$EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE" \
    EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION="$EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION" \
    EMISSION_ADAPT_MAX_GEOMETRY_FRACTION="$EMISSION_ADAPT_MAX_GEOMETRY_FRACTION" \
    python -m arrhenius_fracture.mode_i_first_passage_v10_0_5_18_2_four_class_state_coupled_stochastic_emission \
...
export ADAPTIVE_EVENT_TARGET EMISSION_ADAPT_MAX_LOG_HAZARD_CHANGE
export EMISSION_ADAPT_MAX_BACKSTRESS_FRACTION EMISSION_ADAPT_MAX_GEOMETRY_FRACTION
export EMISSION_MAX_ACTION_SUBSTEP EMISSION_MAX_EVENTS_PER_HALF_STEP
...
echo "Focused v10.0.5.18.2 validation complete: $CAMPAIGN_ROOT"
