#!/usr/bin/env python3
"""Select the v9.18 persistent-wake Mode-I entry point."""
...
def main():
    ...
    _base.build_command = _build_command_v918
    try:
        return _base.main()
    finally:
