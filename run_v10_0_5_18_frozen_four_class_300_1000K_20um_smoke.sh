...
CAMPAIGN_ROOT=${CAMPAIGN_ROOT:-$ROOT/runs/v10_0_5_18_frozen4_anisotropic_300_1000K_20um_smoke_v1}
...
RUN_J_SCALE_DIAGNOSTIC=${RUN_J_SCALE_DIAGNOSTIC:-0}
...
release=10.0.5.18-frozen-four-class-quality-subdivision
entry=arrhenius_fracture.mode_i_first_passage_v10_0_5_18_four_class_standalone
...
adaptive_czm_atomic_collinear_subdivision=true
adaptive_czm_quality_subdivision_counts=$QUALITY_SUBDIVISION_COUNTS
...
run_case() {
  ...
  local -a CMD
  CMD=(
    python -m arrhenius_fracture.mode_i_first_passage_v10_0_5_18_four_class_standalone
...
export QUALITY_SUBDIVISION_COUNTS
...
echo "Standalone frozen four-class v10.0.5.18 smoke complete: $CAMPAIGN_ROOT"
