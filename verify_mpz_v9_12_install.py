...
REQUIRED_V912 = [
    ...
    "arrhenius_fracture/field_snapshots_v912.py",
    "arrhenius_fracture/mode_i_first_passage_v9_12.py",
    "run_mpz_v9_12_mode_i_rcurve.py",
    "run_mpz_v9_12_tip_only_material_rcurve.py",
    "run_mpz_v9_12_tip_only_material_rcurve_fullfield.py",
...
def main() -> None:
    ...
    field = (repo / "arrhenius_fracture/field_snapshots_v912.py").read_text() if not missing else ""
    contracts = {
        "full_2d_fem_entry_present": "existing elastic-plastic FEM supplies K via the J-integral" in sharp,
        "base_field_snapshot_renderer_present": "def _render_field_snapshots" in sharp,
        "mapped_mpz_density_renderer_present": "def map_mpz_density_to_elements" in field,
        "field_snapshot_has_stress": "sigma1_Pa" in field,
        "field_snapshot_has_mapped_density": "rho_mpz_mapped_m2" in field,
        "field_snapshot_has_crack_path": "front_paths" in field,
        "field_snapshot_arrays_persisted": "np.savez_compressed" in field,
    }
    result = {
        "repo": str(repo),
        "missing": missing,
