...
OUTROOT=${OUTROOT:-runs/mpz_v9_13_deterministic_material_transfer_700K_v1}
SEEDS=${SEEDS:-"1"}
...
RNG_COUPLING=${RNG_COUPLING:-common}
...
mkdir -p "$OUTROOT"
"$PYTHON_BIN" verify_mpz_v9_13_install.py .
...
echo "v9.13 deterministic material-transfer gate"
...
echo "  full specimen and tip-zoom fields=required"

"$PYTHON_BIN" run_mpz_v9_13_deterministic_material_transfer.py \
